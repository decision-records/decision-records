<script lang="ts">
	...
	// (an icon button that opens a WAI-ARIA APG listbox) — see
	// lily-design-system-svelte-theme-picker's own spec/index.md.
	//
	...
	// under the same "dr-theme" key app.html's inline script already
